...
// File paths
const configFilePath = path.join(__dirname, '../public/setup/config/config-prod.js')
const languageDirPath = path.join(__dirname, '../public/setup/assets/languages')
const wizardPath = path.join(__dirname, '../public/setup/')
